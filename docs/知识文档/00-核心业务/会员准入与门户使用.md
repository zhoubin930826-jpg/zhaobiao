...
会员是门户的受控访问主体。系统允许门户自注册，但注册成功不等于可登录和下载；后台管理员必须完成业务类型、过期时间、启用状态和下载权限配置。
...
| 后台会员管理 | `MemberAdminController` | `MemberAdminService` | `frontend/src/pages/sys/member/index.vue` |
