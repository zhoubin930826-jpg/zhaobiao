...
public class DataInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        upsertMenu("MEMBER_EDIT_BUTTON", "编辑会员按钮", MenuType.BUTTON, memberUserManage.getId(),
                "", "", "", 8, false, true, "编辑会员按钮");
        upsertMenu("MEMBER_REGISTRATION_SETTING_BUTTON", "会员注册开关按钮", MenuType.BUTTON, memberUserManage.getId(),
                "", "", "", 9, false, true, "开启或关闭门户会员自助注册按钮");
        ...
        upsertRole(
                ...
                "负责会员、招标、角色、菜单和日志管理",
                true,
                new String[]{"DASHBOARD", "PROFILE", "SYSTEM_ROOT", "SYSTEM_MEMBER_USER", "SYSTEM_BUSINESS_TYPE", "SYSTEM_TENDER", "SYSTEM_NEWS", "SYSTEM_ROLE", "SYSTEM_MENU", "SYSTEM_OPERATION_LOG", "MEMBER_CREATE_BUTTON", "MEMBER_EDIT_BUTTON", "MEMBER_REGISTRATION_SETTING_BUTTON", "MEMBER_DOWNLOAD_BUTTON", "MEMBER_STATUS_BUTTON", "MEMBER_PASSWORD_BUTTON", "MEMBER_DELETE_BUTTON", "BUSINESS_TYPE_CREATE_BUTTON", "BUSINESS_TYPE_EDIT_BUTTON", "BUSINESS_TYPE_STATUS_BUTTON", "BUSINESS_TYPE_DELETE_BUTTON", "TENDER_CREATE_BUTTON", "TENDER_EDIT_BUTTON", "TENDER_DELETE_BUTTON", "TENDER_PUBLISH_BUTTON", "TENDER_UPLOAD_BUTTON", "NEWS_CREATE_BUTTON", "NEWS_EDIT_BUTTON", "NEWS_DELETE_BUTTON", "NEWS_PUBLISH_BUTTON", "NEWS_UPLOAD_BUTTON", "ROLE_EDIT_BUTTON", "MENU_EDIT_BUTTON", "PROFILE_EDIT_BUTTON"}
        );
