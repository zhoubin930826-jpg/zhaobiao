...
@Tag(name = "管理员-权限管理（已停用）")
@RestController
@RequestMapping("/api/admin/permissions")
@PreAuthorize("hasRole('ADMIN')")
public class PermissionController {

    private static final String PERMISSION_INTERFACE_DISABLED_MESSAGE = "权限管理接口已停用，请使用菜单/按钮编码作为授权编码";
    ...
    private BusinessException permissionInterfaceDisabled() {
        return new BusinessException(410, PERMISSION_INTERFACE_DISABLED_MESSAGE);
    }
}
