...
INSERT IGNORE INTO sys_menu (code, name, type, parent_id, route_path, component, icon, sort_order, visible, enabled, permission_code, description, created_at, updated_at) VALUES
    ('DASHBOARD', CONVERT(0xE5B7A5E4BD9CE58FB0 USING utf8mb4), 'MENU', NULL, '/dashboard/console', 'dashboard/console', 'House', 10, 1, 1, 'dashboard:view', CONVERT(0xE7B3BBE7BB9FE9A696E9A1B5 USING utf8mb4), @seed_now, @seed_now),
    ('PROFILE', CONVERT(0xE4B8AAE4BABAE4B8ADE5BF83 USING utf8mb4), 'MENU', NULL, '/profile/index', 'profile/index', 'User', 20, 1, 1, 'profile:view', CONVERT(0xE4B8AAE4BABAE4BFA1E681AFE7BBB4E68AA4 USING utf8mb4), @seed_now, @seed_now),
...
INSERT IGNORE INTO sys_menu (code, name, type, parent_id, route_path, component, icon, sort_order, visible, enabled, permission_code, description, created_at, updated_at) VALUES
    ('SYSTEM_ADMIN_USER', CONVERT(0xE7AEA1E79086E59198E7AEA1E79086 USING utf8mb4), 'MENU', (SELECT id FROM sys_menu WHERE code = 'SYSTEM_ROOT'), '/system/user', 'sys/user', 'UserFilled', 10, 1, 1, 'admin:user:view', CONVERT(0xE7AEA1E79086E59198E8B4A6E58FB7E7AEA1E79086E9A1B5E99DA2 USING utf8mb4), @seed_now, @seed_now),
    ('SYSTEM_MEMBER_USER', CONVERT(0xE4BC9AE59198E7AEA1E79086 USING utf8mb4), 'MENU', (SELECT id FROM sys_menu WHERE code = 'SYSTEM_ROOT'), '/system/member', 'sys/member', 'User', 20, 1, 1, 'member:view', CONVERT(0xE4BC9AE59198E8B4A6E58FB7E7AEA1E79086E9A1B5E99DA2 USING utf8mb4), @seed_now, @seed_now),
    ('SYSTEM_BUSINESS_TYPE', CONVERT(0xE7B1BBE59E8BE7AEA1E79086 USING utf8mb4), 'MENU', (SELECT id FROM sys_menu WHERE code = 'SYSTEM_ROOT'), '/system/business-type', 'sys/business-type', 'Collection', 30, 1, 1, 'business:type:view', CONVERT(0xE4B89AE58AA1E7B1BBE59E8BE7AEA1E79086E9A1B5E99DA2 USING utf8mb4), @seed_now, @seed_now),
    ('SYSTEM_TENDER', CONVERT(0xE68B9BE6A087E7AEA1E79086 USING utf8mb4), 'MENU', (SELECT id FROM sys_menu WHERE code = 'SYSTEM_ROOT'), '/tenders', 'sys/tender', 'Document', 40, 1, 1, 'tender:view', CONVERT(0xE68B9BE6A087E4BFA1E681AFE7AEA1E79086E9A1B5E99DA2 USING utf8mb4), @seed_now, @seed_now),
    ...
    ('SYSTEM_ROLE', CONVERT(0xE8A792E889B2E7AEA1E79086 USING utf8mb4), 'MENU', (SELECT id FROM sys_menu WHERE code = 'SYSTEM_ROOT'), '/system/role', 'sys/role', 'Avatar', 70, 1, 1, 'role:view', CONVERT(0xE8A792E889B2E7AEA1E79086E9A1B5E99DA2 USING utf8mb4), @seed_now, @seed_now),
    ('SYSTEM_PERMISSION', CONVERT(0xE69D83E99990E7AEA1E79086 USING utf8mb4), 'MENU', (SELECT id FROM sys_menu WHERE code = 'SYSTEM_ROOT'), '/system/permissions', 'sys/permissions', 'Lock', 80, 1, 1, 'permission:view', CONVERT(0xE69D83E99990E7AEA1E79086E9A1B5E99DA2 USING utf8mb4), @seed_now, @seed_now),
    ('SYSTEM_MENU', CONVERT(0xE88F9CE58D95E7AEA1E79086 USING utf8mb4), 'MENU', (SELECT id FROM sys_menu WHERE code = 'SYSTEM_ROOT'), '/system/menu', 'sys/menu', 'Menu', 90, 1, 1, 'menu:view', CONVERT(0xE88F9CE58D95E7AEA1E79086E9A1B5E99DA2 USING utf8mb4), @seed_now, @seed_now),
    ('SYSTEM_OPERATION_LOG', CONVERT(0xE6938DE4BD9CE697A5E5BF97 USING utf8mb4), 'MENU', (SELECT id FROM sys_menu WHERE code = 'SYSTEM_ROOT'), '/log', 'system/log', 'Tickets', 100, 1, 1, 'operation:log:view', CONVERT(0xE6938DE4BD9CE697A5E5BF97E9A1B5E99DA2 USING utf8mb4), @seed_now, @seed_now);
...
UPDATE sys_menu SET visible = 0, enabled = 0, updated_at = @seed_now WHERE code IN ('SYSTEM_USER', 'SYSTEM_AUDIT_RECORD', 'USER_AUDIT_BUTTON', 'USER_ROLE_BUTTON');
...
UPDATE sys_menu SET route_path = '/system/permissions', component = 'sys/permissions', visible = 1, enabled = 1, updated_at = @seed_now WHERE code = 'SYSTEM_PERMISSION';
